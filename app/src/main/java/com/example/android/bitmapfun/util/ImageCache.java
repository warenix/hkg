...
public class ImageCache {
	...
	/**
	 * Find and return an existing ImageCache stored in a {@link com.example.android.bitmapfun.util.ImageCache.RetainFragment}
	 * , if not found a new one is created using the supplied params and saved
	 * to a {@link com.example.android.bitmapfun.util.ImageCache.RetainFragment}.
	 * 
