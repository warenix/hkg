...
public abstract class ImageWorker {
	 ...
	 * {@link com.example.android.bitmapfun.util.AsyncTask} will be created to asynchronously load the bitmap.
	 * 
	 * @param data
	...
	public void loadImage(Object data, ImageView imageView) {
		...
		if (mImageCache != null) {
			...
			if (bitmap == null) {
				// Bitmap is not found in memory cache, try disk cache
				bitmap = mImageCache.getBitmapFromDiskCache(String
						.valueOf(data));
			}
		}
	...
	/**
	 * Adds an {@link com.example.android.bitmapfun.util.ImageCache} to this worker in the background (to prevent
	...
	/**
	 * Sets the {@link com.example.android.bitmapfun.util.ImageCache} object to use with this ImageWorker. Usually
	 * you will not need to call this directly, instead use
	 * {@link com.example.android.bitmapfun.util.ImageWorker#addImageCache} which will create and add the
	 * {@link com.example.android.bitmapfun.util.ImageCache} object in a background thread (to ensure no disk
